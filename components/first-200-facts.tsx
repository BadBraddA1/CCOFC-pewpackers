...
const first200FactsData: FactItem[] = [
  ...
  // Add more items here to complete the 200 facts
]

export default function First200Facts() {
  const [gameMode, setGameMode] = useState<"flashcard" | "quiz">("flashcard")

  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardContent className="p-6">
        <h2 className="text-2xl font-bold mb-6 text-center">First 200 Facts</h2>
        ...
        {gameMode === "flashcard" && <FactFlashcardGame data={first200FactsData} />}
        {gameMode === "quiz" && <QuizGame title="First 200 Facts" data={first200FactsData} mode="regular" />}
      </CardContent>
    </Card>
  )
}
